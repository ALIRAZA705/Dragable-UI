...
// import Testing from '../DragableUI/Testing'
...
import Testing from '../routes/DragableUI/Testing';
import Beautiful from '../routes/DragableUI/Beautifuldnd';
...
export const RoutedContent = () => {
    return (
        <Switch>
            ...
            {/* page link */}
            {/* <Route path='/tesing' exact component={Testing} /> */}
            {/* <Route exact path="/tesing" render={<Testing/>} /> */}
            <Route path="/test" exact component={Testing} />
            <Route path="/bet" exact component={Beautiful} />
